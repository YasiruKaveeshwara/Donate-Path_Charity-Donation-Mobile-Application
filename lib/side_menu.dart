...
class _SideMenuState extends State<SideMenu> {
                  ...
                  items: [
                    _buildMenuItem(
                      ...
                      onTap: () {
                        ...
                        Navigator.pushNamed(context, '/volunteer_dashboard');
                      },
                    ),
                    _buildMenuItem(
                      context,
                      ...
                      onTap: () {
                        Navigator.pop(context);
                        Navigator.pushNamed(context, '/volunteer_list');
                      },
                    ),
                  ],
                ),
  ...
  Widget _buildMenuItem(BuildContext context,
    ...
    return ListTile(
      ...
      title: Text(label),
      onTap:
          onTap, // Remove the Navigator.pop here since we handle it in _navigateBasedOnUserType
    );
  }
}
